...
I used anonymized data and included schema and query examples only. I did not include private student records, personally identifiable information, or confidential admissions data.
